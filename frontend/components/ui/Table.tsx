/**
 * Table component with shadcn/ui patterns
 *
 * Provides a semantic HTML table with Tailwind styling.
 * Composable sub-components for Table, Header, Body, Row, Head, Cell, and Footer.
 */
