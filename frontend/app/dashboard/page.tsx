            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-md">
              <div className="px-4 py-8 text-center">
                <svg className="mx-auto h-12 w-12 text-gray-400" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m6.75 18H3.75A1.875 1.875 0 011.875 16.125V4.875A1.875 1.875 0 013.75 3H6.75c.828 0 1.5.672 1.5 1.5v.5c0 .828.672 1.5 1.5 1.5h3c.828 0 1.5-.672 1.5-1.5v-.5c0-.828.672-1.5 1.5-1.5h3A1.875 1.875 0 0121 4.875v11.25c0 1.035-.84 1.875-1.875 1.875H15.75Z" />
                </svg>
